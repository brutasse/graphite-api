...
symbols = """(){},=.'"\\"""
arg = Group(boolean | number | aString | expression)("args*")
...
call = Group(
    funcname
    + leftParen
    + Optional(args + Optional(comma + kwargs))
    + rightParen
)("call")
...
matchEnum = Combine(
    leftBrace + delimitedList(partialPathElem, combine=True) + rightBrace
)
...
pathExpression = delimitedList(pathElement, delim=".", combine=True)(
    "pathExpression"
)
